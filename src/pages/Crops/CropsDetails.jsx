    ...
    <div className="w-8/12 mx-auto grid grid-cols-1 py-8 gap-7">
      <div>
        <div className="grid md:grid-cols-2 grid-cols-1 gap-9">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">Crop Name : {crop.name}</h1>
            <p className=" font-bold mb-5 text-xl">Price: ৳{crop.price}</p>
            <div className="flex gap-3 items-center">
              <p>
                Type :
                <span className="text-sm  mb-1 px-3 py-2 rounded-full ">
                  {crop.type}
                </span>
              </p>
            </div>
